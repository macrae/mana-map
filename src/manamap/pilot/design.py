...
/* The Kill's index: the verified lines that did not get a feature spread. They
   keep their whole authored argument and lose only the staging, so a row is a
   short article rather than a link — the head is what compresses.
