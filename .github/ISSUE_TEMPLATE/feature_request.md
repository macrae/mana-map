...
about: Something the project should do and does not
labels: enhancement
---

## The thing you wanted to do, and what stopped you

<!-- The use case rather than the implementation, if you can. This project has
     changed direction several times because someone described a problem better
     than the existing solution did. -->
