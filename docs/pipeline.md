...
| 12 | `cluster-regions` | `analysis/cluster_regions.py` | HDBSCAN named regions, both maps, 3 zoom levels (L2 nests inside L1) | `data/regions_default.json`, `data/regions_ability.json` |
