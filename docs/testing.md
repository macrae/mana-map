...
As of 2026-09-13: **3,791 tests** across 177 files — 3,537 in the `make test`
...
exist in the source** — there are 2,801 top-level `def test_` functions and 3,791 collected cases, the difference
