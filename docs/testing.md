...
```bash
.venv/bin/python -m pytest              # everything (1,127, ~7 min)
...
1,127 tests in `tests/`: 438 card-pipeline + 601 pilot-subsystem + **88 browser**.
...
### Browser tests (88) — `tests/test_viz_behaviour.py` + `test_decklist_parity.py`
