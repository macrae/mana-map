...
```bash
.venv/bin/python -m pytest              # everything (1,131, ~7 min)
...
1,131 tests in `tests/`: 438 card-pipeline + 601 pilot-subsystem + **92 browser**.
...
### Browser tests (92) — `tests/test_viz_behaviour.py` + `test_decklist_parity.py`
