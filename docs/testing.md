...
```bash
.venv/bin/python -m pytest              # everything (1,130, ~7 min)
...
1,130 tests in `tests/`: 438 card-pipeline + 601 pilot-subsystem + **91 browser**.
...
### Browser tests (91) — `tests/test_viz_behaviour.py` + `test_decklist_parity.py`
