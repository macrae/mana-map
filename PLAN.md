...
| `edgar-vampires` | The pilot's physical deck superseded the old builder experiment (both eras in HISTORY.md); **published** as Vol. 006 — Mardu vampire tribal, floor 4, **4/4 verified stacks** incl. both bracket-driving infinites (Exquisite+Vito 38-iteration table-kill; Conqueror+Vito with its per-iteration removal window named), 2 decision spreads, 36-card sideboard analysis. Ingestion caught an illegal Crosis's Catacombs (U identity) — replaced by Nomad Outpost |
